...
<div class="wrapper">
  ...
  <jsp:include page="../include/nav.jsp">
  	...
  	<jsp:param value="active" name="a3"/>
  </jsp:include>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">요청시 다비육종 생시체중 업로드</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="${_ctx }/dl.do?key=${_key }&fid=4" target="_new">생시체중_양식</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <!-- form start -->
          <form role="form" name="searchForm" method="POST" action="${_ctx }/excel/dabi_seangsi_chejung.do" enctype="multipart/form-data">
		  	<input type="hidden" name="fid" value="4" />
  			<input type="hidden" name="farmNo" />
          	<input type="hidden" name="farmName" />
          	<input type="hidden" name="company" />
          	<input type="hidden" name="headerRowNo" value="4" />
          	<input type="hidden" name="readRowNo" value="5" /> <!-- 헤더 바로 다음줄 번호 -->
            <div class="row mb-2">
          ...
          <div class="card card-default"> <!-- /.card-div start -->
              ...
              <div class="card-body">
                <div class="callout callout-danger">
                  <h5>주의</h5>
                  <p>1. 생시체중_양식 파일과 형식이 다른 Excel 데이터는 업로드 되지 않습니다.</p>
                  <p>- 4행 붉은선 항목의 글자, 순서가 동일해야 합니다.</p>
                  <p>- D열의 생시체중을 사용합니다.</p>
                  <img src="" />
				  <img src="${_ctx }/static/images/seangsiChejungHelp.png" alt="생시체중 엑셀" >
				  <p></p>
                  <p>2. 업데이트 요청 농장을 선택하세요.</p>
                  <p>3. 업로드할 엑셀 파일을 선택하세요.</p>
                  <p>4. 확인을 누르면 선택한 농장의 생시체중 자료가 업데이트 됩니다.</p>
                </div>
              </div>
            </div>
          </div> <!-- /.card-div end -->
