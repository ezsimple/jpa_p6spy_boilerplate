        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="${_ctx }/dl.do?key=${_key }&fid=3" target="_new">샘플포맷파일 다운로드</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
          <!-- form start -->
          <form role="form" method="POST" action="${_ctx }/excel/farm_migration.do" enctype="multipart/form-data">
            <div class="card-body">
